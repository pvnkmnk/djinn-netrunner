...
type Library struct {
	...
	MaxSizeBytes *int64    `gorm:"default:null" json:"max_size_bytes"` // nil = no limit
	QuotaAlertAt *int      `gorm:"default:80" json:"quota_alert_at"`   // percentage threshold for alerts
